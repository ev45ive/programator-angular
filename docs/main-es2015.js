...
let PostCommentEditorComponent = class PostCommentEditorComponent {
    constructor() {
        this.comment = {
            postId: null,
            userId: null,
...
let PostsGridComponent = class PostsGridComponent {
    constructor() { }
    ngOnInit() { }
};
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let SearchFormComponent = class SearchFormComponent {
    constructor() {
        ...
        // https://rxmarbles.com/
        valueChanges
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["debounceTime"])(400), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(v => v.trim()), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["filter"])(v => v.length >= 3), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["distinctUntilChanged"])())
            .subscribe({
            next: value => {
...
SearchPostsService.ctorParameters = () => [
...
const API_URL = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["InjectionToken"]("API host url string");
...
let PostsSearchViewComponent = class PostsSearchViewComponent {
    constructor(searchService) {
        this.searchService = searchService;
        this.posts = [];
        this.posts$ = this.searchService.resultsChange.pipe(
        // tap(console.log),
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(posts => (this.posts = posts)));
    }
    search(query) {
...
PostsSearchViewComponent.ctorParameters = () => [
...
let PostsViewComponent = class PostsViewComponent {
    constructor(http) {
        this.http = http;
        this.posts = [];
...
PostsViewComponent.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
let SyncSearchComponent = class SyncSearchComponent {
    constructor() { }
    ngOnInit() {
    }
};
